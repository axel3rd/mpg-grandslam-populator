...
@SpringBootTest(properties = { "mpg.leagues.exclude = MLAX7HMK,MLEFEX6G", "mpg.users.exclude=0000" })
@Sql({ "/schema-test.sql", "/datas-test.sql" })
class GrandslamPopulatorBatchApplicationWithEndLeagueTest extends AbstractTestMpgData {
